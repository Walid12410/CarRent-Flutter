...
class CompanyCarSearchPage extends StatefulWidget {
  const CompanyCarSearchPage({super.key,required this.companyId});

  final String companyId;

  @override
  State<CompanyCarSearchPage> createState() => _CompanyCarSearchPageState();
}

class _CompanyCarSearchPageState extends State<CompanyCarSearchPage> {
  ...
  void _performSearch(String query) async {
    ...
    try {
      List<Car> results = await service.searchCompanyCar(query,widget.companyId);
      setState(() {
